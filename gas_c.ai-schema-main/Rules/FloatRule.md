...
整數判斷規則，這個規則有基本的判斷，輸入的值必須要為數字，繼承自 [Base Rule](BaseRule.md) 

| 屬性           | 資料型態 | 必要屬性 | 描述                                      | 支援變數        | 版本 |
| -------------- | -------- | -------- | ----------------------------------------- | --------------- | ---- |
| *Type*         | string   | Y        | 類型，值為 `float`                        | **X**           | 1.0  |
| **Condition**  | string   | Y        | [判斷條件 (Condition)](#-condition)       | **X**           | 1.0  |
| **Value**      | double   | N        | 期望的輸入                                | **O** **`[1]`** | 1.0  |
| **Value2**     | double   | N        | 期望的輸入，僅 Condition為 between 時使用 | **O ****`[1]`** | 1.0  |
