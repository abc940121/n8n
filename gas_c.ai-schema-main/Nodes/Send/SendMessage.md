...
| *Type*  | string                                  | Y        | 類型，值為 `sending.message`                   | **X**             | 1.0                              |
| **Message** | [MessageContent](../../Contents/MessageContent.md) | Y        | 訊息內容 `(二擇一)` | **X** | 1.0 |
| **Messages** | [MessageContent[]](../../Contents/MessageContent.md) | Y | 多個訊息內容 `(二擇一)` | **X** | 1.1 |
