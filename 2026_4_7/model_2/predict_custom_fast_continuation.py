...
LORA_ADAPTER = "/work/u4439705/n8n_qwen35_lora_v2"

INPUT_FILE = "/work/u4439705/data/test_100_prompts.jsonl"
OUTPUT_FILE = "/work/u4439705/n8n_predicted_workflows_v2.jsonl"

CHUNK_TOKENS = 4096   # 每次最大生成數量
MAX_CHUNKS = 8        # 最多允許「自動接續」8次 (最高可達 32K Token!)

def main():
    print("\n" + "="*50)
    print("🚀 啟動 H200 Turbo 高速推論模式 (BF16 + 自動接續生成)")
    print("="*50 + "\n")
    ...
    print(f"🔥 開始超長文本超速推理，剩餘 {len(pending_tasks)} 筆資料...")
    ...
    print(f"✅ 推論全部完成！結果儲存在 {OUTPUT_FILE}")
