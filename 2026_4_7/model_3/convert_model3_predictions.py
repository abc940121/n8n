...
# ================= 設定區 =================
INPUT_FILE = r"c:\Users\User\Desktop\C.ai_project\2026_4_7\model_3\n8n_predicted_workflows_model3.jsonl"
EVAL_BASE_DIR = r"c:\Users\User\Desktop\C.ai_project\2026_4_7\n8n_workflow_generator\outputs_qwen35_ft_model3"
...
def main():
    if not os.path.exists(INPUT_FILE):
        ...
        print("指令參考: scp u4439705@nano5.nchc.org.tw:/work/u4439705/n8n_predicted_workflows_model3.jsonl .\model_3\\")
        print("="*60)
        return
    ...
    print("\n📦 開始轉換 JSONL 格式至 Evaluation 相容格式 (Model 3)...")
    ...
    print("  python scripts/run_evaluation.py --config evaluation/config/qwen_eval_config_model3.yaml\n")
